  ...
  return (
    <section className="min-h-[80vh] flex items-center bg-white dark:bg-gray-950 pt-24">
      <div className="max-w-6xl mx-auto px-10 w-full">
        <p className="text-xs font-medium text-primary-500 mb-4 tracking-wide uppercase">
          For Web Design Agencies
        </p>
        <h1 className="text-3xl md:text-4xl font-bold text-ink dark:text-white tracking-tight leading-tight max-w-3xl">
        ...
        <div className="mt-10 grid items-center text-center lg:text-left lg:flex flex-col sm:flex-row gap-4">
          <a
            href="#projects"
            className="px-5 py-2 bg-accent-600 hover:bg-accent-700 text-white text-[12px] font-semibold rounded-full transition-all duration-200 shadow-lg shadow-accent-500/25 hover:shadow-accent-500/40"
          >
            See My Work
          </a>
          <a
            href="#contact"
            className="px-5 py-2 bg-white dark:bg-gray-800 text-ink dark:text-white text-[12px] font-semibold rounded-full border border-gray-300 dark:border-gray-700 hover:border-primary-500 hover:text-primary-500 transition-colors text-center"
          >
            Book a Call
          </a>
        </div>
        ...
        <div className="my-10 inline-flex flex-wrap items-center gap-1 rounded-md lg:rounded-full border border-gray-200 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-900/50 backdrop-blur-sm p-1">
          ...
          <span className="flex items-center gap-2 px-4 py-1.5 text-xs font-medium text-gray-700 dark:text-gray-300">
            <Handshake className="w-4 h-4 text-primary-500" strokeWidth={2.5} />
